...
const datailData = () => {
	...
	const renderAnimeDetails = (array, itemId) => {
		...
		const widgetList = document.querySelectorAll('.anime__details__widget ul li');//breadcrumb__links
		...
		if (animeObj) {
			...
			widgetList[1].insertAdjacentHTML('beforeend', `<span>Status:</span>${animeObj.rating}`);
